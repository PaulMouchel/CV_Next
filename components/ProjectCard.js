        ...
        <Link href={`/projects/${slug}`}>
            <a>
                <div className='group relative w-full h-80 cursor-pointer'>
                    <Image src={`https://${thumbnail.fields.file.url}`} alt={`Image pour le site : ${title}`} layout='fill' objectFit='cover' className='transition ease-in-out duration-500 transform group-hover:scale-105 group-hover:opacity-30'/>
